...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'AR STATUS',
    ...
    BOT_INFO: process.env.BOT_INFO || 'AR;ASHEN;94784749430;https://i.ibb.co/8KmjmhC/Whats-App-Image-2021-08-27-at-10-46-16-AM.jpg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'AR;ASHEN;https://i.ibb.co/8KmjmhC/Whats-App-Image-2021-08-27-at-10-46-16-AM.jpg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'AR;ASHEN' : process.env.STICKER_DATA,
